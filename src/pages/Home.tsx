...
const Home = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col sm:flex-col items-end gap-0 sm:gap-6 overflow-x-hidden overflow-y-auto fade-up pt-10 sm:mt-0">
      ...
      <div className="hero h-[100vh] sm:h-full p-0">
        <div className="sm:hero-content  flex flex-col-reverse lg:flex-row-reverse items-start gap-4 sm:w-full h-full  p-0 m-0 sm:p-6 sm:pt-[5%]">
          <CodeMock />
